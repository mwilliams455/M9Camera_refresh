...
public final class Tc20Native1bParityTest {
    ...
    public static void main(String[] args) {
        ...
        if(exp[2]!=got[2] || dm>1e-13 || dp>1e-13) throw new AssertionError("TC20NATIVE1B parity failed dm="+dm+" dp="+dp);
        System.out.println("TC20NATIVE1B Java-vs-JNI weighted-selection parity PASS");
    }
}
