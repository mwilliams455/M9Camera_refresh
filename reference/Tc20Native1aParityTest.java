...
public final class Tc20Native1aParityTest {
    ...
    public static void main(String[] args) {
        ...
        M9NativeColorCore.meterTc20FullSort(ctx,cam,n,w,h,rowW,colW,got);
        ...
        if(exp[2]!=got[2] || dm>1e-13 || dp>1e-13) throw new AssertionError("TC20NATIVE1A parity failed dm="+dm+" dp="+dp);
        System.out.println("TC20NATIVE1A Java-vs-JNI full-sort parity PASS");
    }
}
