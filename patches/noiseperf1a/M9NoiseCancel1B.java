...
final class M9NoiseCancel1B {
    static final String ID="M9NOISEPERF1A_PARALLEL8_EXACT";
    ...
    static JSONObject apply(ByteBuffer rgb,int w,int h,int sourceCfa,
        ...
        d.put("parallelWorkers",(int)stats[12]);
        d.put("parallelMode",stats[13]==1.0?"disjoint_row_bands_preloaded_boundaries":"scalar_reference");
        d.put("pixelMathRevision","NOISECANCEL1B_FROZEN_EXACT");
        d.put("parallelParityPolicy","byte_exact_RGB_output_vs_frozen_1_86_scalar");
