...
checks = {
    ...
    'VirtualBV center/global weights frozen': 'PROVISIONAL_CENTER_WEIGHT = 0.70' in virtual and 'PROVISIONAL_GLOBAL_WEIGHT = 0.30' in virtual and 'PROVISIONAL_REFERENCE_Y = 120.0' in virtual,
