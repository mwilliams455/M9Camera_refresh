...
print('M9LIVEGL1V SOURCE PASS: spatial preview activation verified; exposure allocation, capture route, native color, SAT2/curve02, shader and still renderer preserved')
