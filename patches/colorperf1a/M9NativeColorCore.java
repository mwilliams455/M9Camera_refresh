...
final class M9NativeColorCore {
    ...
    /**
     * COLORPERF1A: exact PERF3I frame render with one persistent native worker team
     * and one Bitmap lock across the unchanged bounded colour blocks.
     * Returns false before pixel mutation so the caller can retain the PERF3I fallback.
     */
    static native boolean renderFramePersistentDirectBitmap(long handle,
                                                            long camAddress,
                                                            int width,
                                                            int sourceHeight,
                                                            android.graphics.Bitmap bitmap,
