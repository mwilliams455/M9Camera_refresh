...
for cls in ['CaptureRequest','CaptureResult']:
    ...
    types={'SENSOR_NEUTRAL_COLOR_POINT':'android.util.Rational[]','COLOR_CORRECTION_GAINS':'android.hardware.camera2.params.RggbChannelVector','CONTROL_AWB_LOCK':'Boolean'}
