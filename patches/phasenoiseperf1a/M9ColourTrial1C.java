...
final class M9ColourTrial1C {
    ...
    static JSONObject apply(short[] norm,ByteBuffer sensor,ByteBuffer rgb,int w,int h,
        ...
        d.put("phaseNoisePerfRevision","M9PHASENOISEPERF1A_BANDED_TERM_REUSE_EXACT");
        d.put("phaseNoisePerfBandRows",64);
        d.put("phaseNoisePerfPolicy","candidate_pair_term_reuse_same_patch_and_candidate_order_exact");
