...
print('M9EXPOSUREPLAN1C SOURCE PASS: EV energy allocation verified; Auto policy, GL1W preview, shader, native color, SAT2/curve02 and still renderer preserved')
