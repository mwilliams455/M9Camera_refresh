...
/** Controlled DETAIL1H candidate. One RAW, fixed green/Sharp, no preview mutation. */
final class M9Detail1H {
    static final String ID = "M9DETAIL1H_NATIVEGUARD";
    private M9Detail1H() {}
    ...
    static JSONObject apply(short[] norm, ByteBuffer raw, ByteBuffer rgb, int width, int height,
        ...
        d.put("noiseCancelRevision","NOISECANCEL1A_QUIETCHROMA");
        d.put("noiseCancelPolicy","boost_only_existing_high_confidence_chroma_residuals");
        d.put("noiseCancelGreenLumaMutation",false);
        d.put("noiseCancelBaseProfileStrength",1.0);
        d.put("noiseCancelConfidenceGateStart",0.65);
        d.put("noiseCancelConfidenceGateFull",0.90);
        d.put("noiseCancelMaxRemainingBlendFraction",0.50);
        ...
        double[] stats=new double[10];double nr=(double)neutral[0]/neutral[1],nb=(double)neutral[2]/neutral[1];
