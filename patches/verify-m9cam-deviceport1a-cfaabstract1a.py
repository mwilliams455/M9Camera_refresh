...
checks = {
    ...
    'descriptor_camera2_vs_photon_cfa': 'camera2PhotonCfaAgreement' in desc and 'photonEffectiveCfa' in desc and 'resolvedCfaSource' in desc,
    'descriptor_camera2_cfa_preferred': 'int resolvedCfa = camera2Cfa >= 0 ? camera2Cfa : photonCfa;' in desc,
    'descriptor_black_level': 'SENSOR_BLACK_LEVEL_PATTERN' in desc,
    'descriptor_black_level_compare': 'photonEffectiveBlackLevel' in desc and 'characteristicsBlackLevelPattern' in desc and 'photonCharacteristicsBlackAgreement' in desc,
    'descriptor_dynamic_black_logged': 'SENSOR_DYNAMIC_BLACK_LEVEL' in desc and 'captureDynamicBlackLevel' in desc,
    'descriptor_white_level': 'SENSOR_INFO_WHITE_LEVEL' in desc and 'SENSOR_DYNAMIC_WHITE_LEVEL' in desc,
    'descriptor_tight_buffer_check': 'rawBufferMatchesTightU16' in desc and 'rawExpectedTightU16Bytes' in desc,
    'descriptor_photon_rawsize_compare': 'photonRawSizeAgreement' in desc,
