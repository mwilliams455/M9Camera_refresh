"""Compile AUTOEXPOSUREFINISH1E and exercise 4x6 body readability, M9 ceiling and inherited temporal stability."""
...
receipt={
 'revision':'M9AUTOEXPOSUREFINISH1E_MULTIFIELD_BODY',
...
(build.parent/'autoexposurefinish1e_tests.json').write_text(json.dumps(receipt,indent=2)+'\n')
print(result,end='')
