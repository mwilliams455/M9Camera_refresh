...
def verify(root):
    ...
    if (root/AUTO).read_bytes()!=(HERE/'M9AutoExposure2D.java').read_bytes():
        raise SystemExit('Auto scene-key candidate mismatch')
    ...
    return {
        'revision':ID,
        'policyRevision':'M9AUTOEXPOSUREFINISH1B_SCENEKEY',
        'version':'1.69-m9autoexposurefinish1b-tg1',
        'versionCode':26689,
        'changed':sorted(CHANGED),
        'positiveSearchMaxEv':2.5,
        'sceneMedianTargetCode':46,
        'sceneCenterTargetCode':54,
        'sceneCenterQ25TargetCode':22,
        'backlightCenterTargetCode':56,
        'backlightCenterQ25TargetCode':22,
        'lowKeyNightBodyProtection':True,
        'backlightBackgroundLossCenterProtected':True,
...
def main(root):
    ...
    gradle=replace_once(gradle,
        ...
        "versionName '1.69-m9autoexposurefinish1b-tg1'",
        'version name')
