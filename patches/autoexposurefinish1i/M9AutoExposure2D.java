...
public final class M9AutoExposure2D {
    public static final String REVISION="M9AUTOEXPOSUREFINISH1I_FASTACQUIRE1B_SAFE075";
    ...
    // 1F: keep the same coherent 4x6 body and the same readability target while
    // the scene remains spatially consistent. A disjoint body must persist for
    // two fresh samples before replacing it.
    ...
    private static BodyCandidate stabilizeBodyCandidate(
        ...
        if(heldPlausible) {
            ...
            if(proposed.valid) {
                ...
                pendingBodyMask=0;pendingBodyConfirmations=0;
                bodyLockReason="held_despite_candidate_noise";
            }
            return held;
        }
