...
public final class M9JpegSignature1A {
    ...
    public static Result read(File file)throws Exception {
        MessageDigest digest=MessageDigest.getInstance("SHA-256"),icc=MessageDigest.getInstance("SHA-256");
        ...
        out.codingSha256=hex(digest.digest());out.iccSha256=out.iccSegments==0?null:hex(icc.digest());return out;
    }
}
