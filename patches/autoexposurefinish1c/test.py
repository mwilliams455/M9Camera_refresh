"""Compile AUTOEXPOSUREFINISH1C and exercise adaptive backlight placement without changing night/scene-key behavior."""
...
receipt={
 'revision':'M9AUTOEXPOSUREFINISH1C_ADAPTIVEBACKLIGHT',
...
(build.parent/'autoexposurefinish1c_tests.json').write_text(json.dumps(receipt,indent=2)+'\n')
print(result,end='')
