...
print('M9EXPOSUREPLAN1B SOURCE PASS: exact overlay; native color, SAT2/curve02 assets, shader, tone model, frame count and M9EXPOSUREPLAN1A sidecar preserved')
