...
checks = [
    ...
    ("GL1K pivot-gamma marker", "M9LIVEGL1K_PIVOTGAMMA1A" in shader),
    ...
    ("GL1K scene gamma", "1.20 + 1.10 * sceneKey1I" in tone),
    ("GL1K pivot gain", "gainEv = gamma1K - 1.0" in tone),
    ("GL1K gamma clamp", "1.18, 2.30" in tone),
