"""Compile AUTOEXPOSUREFINISH1F and exercise multi-field body/target locking plus inherited M9 limits."""
...
receipt={
 'revision':'M9AUTOEXPOSUREFINISH1G_SOFTANCHOR1A',
...
(build.parent/'autoexposurefinish1g_tests.json').write_text(json.dumps(receipt,indent=2)+'\n')
print(result,end='')
