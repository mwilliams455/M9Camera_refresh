"""Compile AUTOEXPOSUREFINISH1D and exercise M9 highlight guard plus preview-stability hysteresis."""
...
receipt={
 'revision':'M9AUTOEXPOSUREFINISH1D_M9HIGHLIGHTGUARD',
...
(build.parent/'autoexposurefinish1d_tests.json').write_text(json.dumps(receipt,indent=2)+'\n')
print(result,end='')
