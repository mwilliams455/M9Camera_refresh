...
def verify(root):
    ...
    return {
      ...
      'centralHighlightAuthorityRequiresReadableBody':True,
      'bodyReadableFloor':{'centerMedian':58,'centerQ25':28},
      'centralClipRelativeAllowanceMax':0.22,
      'centralBrightRelativeAllowanceMax':0.32,
      'bodyTooOpenCeiling':{'centerMedian':100,'centerQ25':42},
