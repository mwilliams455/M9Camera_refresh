...
public final class M9AutoExposure2D {
    public static final String REVISION="M9AUTOEXPOSUREFINISH1K_BGQUAL1A_HIGHLIGHTRET1A";
    ...
    public static double protectedOpenAnchorLiftCap(Stats s,BodyCandidate body) {
        ...
        return protectedOpenAnchorSevereBacklight(s,body)
                ?PROTECTED_ANCHOR_SEVERE_MAX_EV:PROTECTED_ANCHOR_ORDINARY_MAX_EV;
    }
