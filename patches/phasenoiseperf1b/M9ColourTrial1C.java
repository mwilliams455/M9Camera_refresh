...
final class M9ColourTrial1C {
    ...
    static JSONObject apply(short[] norm,ByteBuffer sensor,ByteBuffer rgb,int w,int h,
        ...
        d.put("phaseNoisePerfRevision","M9PHASENOISEPERF1B_SYMTILE_EXACT");
        d.put("phaseNoisePerfBandRows",64);
        d.put("phaseNoisePerfTileCols",512);
        d.put("phaseNoisePerfPolicy","symmetric_pair_weight_reuse_original_candidate_accumulation_order_exact");
