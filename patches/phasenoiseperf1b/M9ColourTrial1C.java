...
final class M9ColourTrial1C {
    ...
    static JSONObject apply(short[] norm,ByteBuffer sensor,ByteBuffer rgb,int w,int h,
        ...
        d.put("reconstructionMs",stats[4]);
        d.put("amazePerfRevision","M9AMAZEPERF1A_PARALLEL_PERIPHERY_EXACT");
        d.put("amazePerfWorkers",(int)stats[13]);
        d.put("amazeRawCopyMs",stats[5]);
        d.put("amazeVarianceMs",stats[6]);
        d.put("amazePhaseNoiseMs",stats[7]);
        d.put("phaseNoisePerfRevision","M9PHASENOISEPERF1B_SYMMETRIC_WEIGHT_REUSE_EXACT");
        d.put("phaseNoisePerfBandRows",32);
        d.put("phaseNoisePerfTileCols",256);
        d.put("phaseNoisePerfPolicy","canonical_halfplane_patch_weights_reused_symmetrically_original_24_candidate_accumulation_order_exact");
        d.put("phaseNoisePerfParentRevision","M9PHASENOISEPERF1A_BANDED_TERM_REUSE_EXACT");
        d.put("amazeQuarterBlendMs",stats[8]);
        d.put("amazeFloatInputMs",stats[9]);
        d.put("amazeCoreMs",stats[10]);
        d.put("amazeOutputQuantizeMs",stats[11]);
